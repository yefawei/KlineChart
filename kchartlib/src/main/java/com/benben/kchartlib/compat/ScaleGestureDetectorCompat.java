package com.benben.kchartlib.compat;
...
public class ScaleGestureDetectorCompat {
     ...
     * be easier to extend {@link ScaleGestureDetectorCompat.SimpleOnScaleGestureListener}.
     * <p>
     * An application will receive events in the following order:
     * <ul>
     *  <li>One {@link ScaleGestureDetectorCompat.OnScaleGestureListener#onScaleBegin(ScaleGestureDetectorCompat)}
     *  <li>Zero or more {@link ScaleGestureDetectorCompat.OnScaleGestureListener#onScale(ScaleGestureDetectorCompat)}
     *  <li>One {@link ScaleGestureDetectorCompat.OnScaleGestureListener#onScaleEnd(ScaleGestureDetectorCompat)}
     * </ul>
     */
    public interface OnScaleGestureListener {
         ...
         * pointers going up.
         * <p>
         * Once a scale has ended, {@link ScaleGestureDetectorCompat#getFocusX()}
         * and {@link ScaleGestureDetectorCompat#getFocusY()} will return focal point
     ...
     * {@link ScaleGestureDetectorCompat.OnScaleGestureListener} but does nothing.
     * {@link ScaleGestureDetectorCompat.OnScaleGestureListener#onScale(ScaleGestureDetectorCompat)} returns
     * {@code false} so that a subclass can retrieve the accumulated scale
     * factor in an overridden onScaleEnd.
     * {@link ScaleGestureDetectorCompat.OnScaleGestureListener#onScaleBegin(ScaleGestureDetectorCompat)} returns
     * {@code true}.
     */
    public static class SimpleOnScaleGestureListener implements ScaleGestureDetectorCompat.OnScaleGestureListener {
    ...
    /**
     * Creates a ScaleGestureDetectorCompat with the supplied listener.
     ...
     */
    public ScaleGestureDetectorCompat(Context context, ScaleGestureDetectorCompat.OnScaleGestureListener listener) {
     ...
     */
    public ScaleGestureDetectorCompat(Context context, OnScaleGestureListener listener,
                                      Handler handler) {
        mContext = context;
        mListener = listener;
        final ViewConfiguration viewConfiguration = ViewConfiguration.get(context);
        mSpanSlop = viewConfiguration.getScaledTouchSlop() * 2;
        mMinSpan = Math.round(context.getResources().getDisplayMetrics().density * 10);
        mHandler = handler;
    ...
    /**
     * Accepts MotionEvents and dispatches events to a {@link ScaleGestureDetectorCompat.OnScaleGestureListener}
     * when appropriate.
     *
    ...
    /**
     * Sets whether the associates {@link ScaleGestureDetectorCompat.OnScaleGestureListener} should receive
